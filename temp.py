...
def predict():
    ...
    predarray = [IncomeEntered,AgeEntered,ExperinceEntered,CJYEntered,CHYEntered,
                IncomeEntered*IncomeEntered, IncomeEntered*AgeEntered,IncomeEntered*ExperinceEntered,
                IncomeEntered*CJYEntered,IncomeEntered*CHYEntered,AgeEntered*AgeEntered,AgeEntered*ExperinceEntered,
                AgeEntered*CJYEntered, AgeEntered*CHYEntered, ExperinceEntered*ExperinceEntered,ExperinceEntered*CJYEntered,ExperinceEntered*CHYEntered,
